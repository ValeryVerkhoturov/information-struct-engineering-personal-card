...
\newcommand{\znanieInostrannogoYazikaFK}{-}
...
\begin{longtable}{ | m{10em} | m{0.5em}| m{30em} | } 
 ...
 \hline
 \firstColumn{Воиский учет}{Определяет}{Классификатор составов}{\ruleManyMondatoryOneOptional} & \ruleManyMondatoryOneOptionalNum & \thirdColumn{\voinsiyUchet}{\voinsiyUchetPK}{\voinsiyUchetFK}{\kSostavov}{\kSostavovPK}{\kSostavovFK} \\ 
